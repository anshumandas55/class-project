...
{
String res="";
System.setProperty("webdriver.chrome.driver", "E:\\Selenium_Evening\\ERP_Stock\\CommonDriver\\chromedriver.exe");
...
public static String verifySupplier(String sname,String addresss, String city,
...
driver.findElement(By.name("x_Address")).sendKeys(addresss);
